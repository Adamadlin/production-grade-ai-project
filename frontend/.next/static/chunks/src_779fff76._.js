...
async function jfetch(path, init) {
    ...
    if (!res.ok) {
        ...
        const msg = text || "HTTP ".concat(res.status) + (retry ? " (Retry-After: ".concat(retry, "s)") : '');
        throw new Error(msg);
    }
    return res.json();
}
const api = {
    ...
    ingest: function(urls) {
        ...
        return jfetch("/ingest?tokens=".concat(tokens, "&overlap=").concat(overlap, "&force=").concat(String(force)), {
            method: 'POST',
            body: JSON.stringify(urls)
        });
    },
    search: function(q) {
        ...
        if (opts === null || opts === void 0 ? void 0 : opts.source) qs.set('source', opts.source);
        if (opts === null || opts === void 0 ? void 0 : opts.domain) qs.set('domain', opts.domain);
        return jfetch("/search?".concat(qs.toString()));
    },
    summarize: function(topic) {
        let params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
        var _params_k, _params_model, _params_temperature, _params_max_tokens;
        const qs = new URLSearchParams({
            topic,
            k: String((_params_k = params.k) !== null && _params_k !== void 0 ? _params_k : 8),
            model: (_params_model = params.model) !== null && _params_model !== void 0 ? _params_model : 'llama3:8b',
            temperature: String((_params_temperature = params.temperature) !== null && _params_temperature !== void 0 ? _params_temperature : 0.1),
            max_tokens: String((_params_max_tokens = params.max_tokens) !== null && _params_max_tokens !== void 0 ? _params_max_tokens : 450)
        });
        if (params.source) qs.set('source', params.source);
        if (params.domain) qs.set('domain', params.domain);
        return jfetch("/summarize?".concat(qs.toString()));
    },
    examples: function() {
        let n = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 6;
        return jfetch("/examples?".concat(new URLSearchParams({
            n: String(n)
        }).toString()));
    }
};
...
function extractCitations(md) {
    ...
    // de-dupe by URL + span
    const key = (x)=>"".concat(x.url, ":").concat(x.start, "-").concat(x.end);
...
function ChatBubble(param) {
    ...
    const linked = content.replace(/\((https?:\/\/[^:()\s]+):(\d+)-(\d+)\)/g, (_m, u, s, e)=>"([".concat(u, ":").concat(s, "-").concat(e, "](").concat(u, "))"));
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])('flex', role === 'user' ? 'justify-end' : 'justify-start'),
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])('max-w-[85%] md:max-w-[70%] rounded-2xl border px-4 py-3 shadow', role === 'user' ? 'bg-blue-600/20 border-blue-500/40 text-blue-50' : 'bg-slate-900 border-slate-800 text-slate-100'),
            "aria-live": "polite",
            children: [
                ...
                citations.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: citations.map((c, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                    ...
                                    target: "_blank",
                                    rel: "noreferrer",
                                    title: "".concat(c.url, ":").concat(c.start, "-").concat(c.end),
                                    children: [
...
_s(Home, "MF8M3BKNG5ajCH0+I/z+nbBdivg=");
_c = Home;
function IngestCard(props) {
    const { urls, setUrls, tokens, setTokens, overlap, setOverlap, force, setForce, runIngest, out, busy } = props;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            out && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("pre", {
...
function ExamplesCard(param) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ExamplesCard.useEffect": ()=>{
            let mounted = true;
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].examples(6).then({
                "ExamplesCard.useEffect": (res)=>{
                    if (!mounted) return;
                    var _res_examples;
                    setItems((_res_examples = res.examples) !== null && _res_examples !== void 0 ? _res_examples : []);
                    setErr(null);
                }
            }["ExamplesCard.useEffect"]).catch({
                "ExamplesCard.useEffect": (e)=>{
                    if (!mounted) return;
            ...
            }["ExamplesCard.useEffect"]).finally({
                "ExamplesCard.useEffect": ()=>mounted && setLoading(false)
            }["ExamplesCard.useEffect"]);
            return ({
                "ExamplesCard.useEffect": ()=>{
                    mounted = false;
...
_s1(ExamplesCard, "/jda/+rebDAd43dtGAG0o1axcnk=");
_c2 = ExamplesCard;
var _c, _c1, _c2;
...
//# sourceMappingURL=src_779fff76._.js.map